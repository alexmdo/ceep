...
public class NotaDAO extends SQLiteOpenHelper {
    ...
    public List<Nota> todos() {
        ...
        String queryTodasNotas = "SELECT * FROM " + TABLE_NAME + " ORDER BY " + COLUMN_POSICAO + " desc";
    ...
    public void troca(Nota notaPosicaoInicio, Nota notaPosicaoFim) {
        ...
        Collections.swap(notas, notaPosicaoInicio.getPosicao(), notaPosicaoFim.getPosicao());
    }
